...
//String path="K:/upload"; -> [Servers->server.xml]
		

//String path = request.getSession().getServletContext().getRealPath("/"); //<-Servlet에 적용
...
try {
	...
	//session.setAttribute("id", "user") = (name1, value[bFile])
	...
	originalFile = multi.getOriginalFileName(name1); 
	
	originalFile2 = multi.getOriginalFileName(name2); 
	...
	//bt데이터 추가메소드 호출
	int check = dao2.e_write(bTitle, bContent, bFile, bFile2);
