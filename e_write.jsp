...
<body>
	<section>
		...
		<form action="e_upload_ok.jsp" name="e_write" method="post" enctype="multipart/form-data">
			<table>
				<colgroup>
					<col width="15%">
					<col width="85%">
			...
			<div class="button-wrapper">
				...
				<button type="button" class="cancel" onclick="javascript:location.href='e_list.jsp'">취소</button>
			</div>
